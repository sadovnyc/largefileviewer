...
/**
 * Array of int that can grow without performing re-allocation.
...
public class ChunkIntArray
{
	 ...
	 * @param chunkSize
	 */
	public ChunkIntArray(int chunkSize)
	{
		super();
	...
	public void add(int element)
	{
		...
		{
			//need a new chunk
			indexCache.add(new int[chunkSize]);
		}
	 ...
	 */
	public void add(int[] elements, int len)
	{
		int offset;
